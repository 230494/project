...
?>
<META HTTP-EQUIV = 'Refresh' Content = '5; URL =<?php echo Yii::app()->request->baseUrl.'/site/index'; ?>'>
...
<div style="text-align:center">
		...
		<?php 		
			...
			?>
	<br /><br />
	<?php if(! isset(Yii::app()->session['id_pemilih'])): ?>
	<div class='alert alert-danger'>
	
	<h4><strong>Pemilih Tidak Terautentikasi </strong></h4>
	</div>
<?php endif;?>

	<?php

	if(isset(Yii::app()->session['id_pemilih'])): ?>
	...
	<br />
	<a class="btn btn-primary btn-circle btn-xl" href="<?php  echo Yii::app()->request->baseUrl.'/site/count/'.$dat['id_kandidat']; ?>"><h3>Pilih</h3></a>	
	<a class="btn btn-danger btn-circle btn-xl" href="<?php echo Yii::app()->request->baseUrl.'/site/index'; ?>"><h3>Tidak</h3></a>
<?php endif; ?>
	</div>