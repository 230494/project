...
<script type='text/javascript'>
  /*function reloadNames() {
    var url = '<?php echo Yii::app()->request->baseUrl; ?>'+'/hasil/getgrafik';
...
<h1>Hasil Suara</h1>
						...
						<center>
							...
							echo "<h4 style='text-align:center'>Saat Ini Sistem Tidak Dapat Melakukan Perhitungan Suara. Karena Proses Pemilihan Masih Berlangsung</h4>";
							echo "</div>";
							}else if(true){
							
							echo "<a  href='' class='btn btn-primary btn-large'>Hitung Hasil Suara</a>";
