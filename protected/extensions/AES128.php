<?php
	...
	// Author: Jack Servedio <jack@jservedio.com>
	...
	/* About This Class
	   Requirements:
		...
		About:
		This class implements AES-128 Encryption utilizing the PHP Mcrypt Library with the Rijndael-128 Algorithm in ECB, CFB, or CBC Mode. This encryption method uses an Intialization Vector as “seed” along with a 128-bit key. The encrypted data is stored in Base 64 prepended by the Initialization Vector also in Base 64.
	...
	*/
	...
	class AES128 {
		...
		public function AES128( $key = "", $mode = "CBC" ) {
		...
		private function generate_iv() {
			...
			//$this->iv = mcrypt_create_iv( mcrypt_get_block_size( MCRYPT_RIJNDAEL_128, MCRYPT_MODE_CFB ), MCRYPT_RAND );
		...
		public function encrypt( $data ) {
			...
			//$this->encrypted_data = mcrypt_encrypt( MCRYPT_RIJNDAEL_128, $this->key, $this->data, MCRYPT_MODE_CFB, $this->iv );
		...
		public function decrypt( $encrypted_string ) {
			...
			//$this->data = mcrypt_decrypt( MCRYPT_RIJNDAEL_128, $this->key, $this->encrypted_data, MCRYPT_MODE_CFB, $this->iv);
